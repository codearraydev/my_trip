    ...
    return (
        ...
        <div className="col-sms-6 col-sm-6 col-md-4">
            <article className="box">
                <figure>
                    <Link to={props.destLink}><a href="#" title className="hover-effect"><img style={{ width: '100%', height: 160, objectFit: 'cover' }} src={props.picture} alt width={270} height={160} /></a></Link>
                </figure>
                <div className="details">
                    <Link to={props.destLink}><a title="View all" href="#" className="pull-right button uppercase">select</a></Link>
                    <Link to={props.destLink}><h5 style={{ height: 15, overflow: 'hidden' }} className="box-title">{props.destName}</h5></Link>
